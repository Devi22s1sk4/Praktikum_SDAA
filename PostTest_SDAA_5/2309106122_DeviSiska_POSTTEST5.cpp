...
void sortAlumniDescending() {
    head = mergeSort(head); 
    operationHistory.push("Sort Alumni Descending by ID (Merge Sort)");
    cout << "Data alumni berhasil diurutkan secara descending berdasarkan ID!" << endl;
    tampilkanAlumni();  
}
...
void tampilkanMenu() {
    ...
    cout << "5. Undo Hapus Alumni" << endl;
    cout << "6. Riwayat Operasi" << endl;
    cout << "7. Verifikasi Alumni" << endl;
    cout << "8. Urutkan Alumni (Ascending)" << endl;
    cout << "9. Urutkan Alumni (Descending)" << endl;
    cout << "10. Keluar" << endl;
}
